              ...
              {completedQuotes.map(q => (
                <div key={q.id}>
                  ...
                  {selectedQuote?.id === q.id && generating && (
                    <div style={{ padding:"12px 16px", background:C.accentDim, borderRadius:"0 0 8px 8px", border:`1px solid ${C.accent}`, borderTop:"none", display:"flex", alignItems:"center", gap:10 }}>
                  ...
                  {selectedQuote?.id === q.id && posts && (
                    <div style={{ background:C.surface, border:`1px solid ${C.accent}`, borderTop:"none", borderRadius:"0 0 8px 8px", padding:16 }}>
